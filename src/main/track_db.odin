...
_track_to_db_model :: proc(l: Library, t: Track, allocator: mem.Allocator) -> (model: _Track_DB_Model, error: Error) {
	return _Track_DB_Model {
		...
		artist           = library_format_track_common_strings_to_allocator(l, t.artists, .Artist, allocator),
		album            = library_get_album_name(l, t.album),
		genre            = library_format_track_common_strings_to_allocator(l, t.genres, .Genre, allocator),
		title            = t.title,
