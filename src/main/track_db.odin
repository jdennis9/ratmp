...
_track_to_db_model :: proc(l: Library, t: Track, allocator: mem.Allocator) -> (model: _Track_DB_Model, error: Error) {
	return _Track_DB_Model {
		...
		artist           = library_format_track_group_set_to_allocator(t.artists, l.artists, allocator),
		album            = library_get_album_name(l, t.album),
		genre            = library_format_track_group_set_to_allocator(t.genres, l.genres, allocator),
		title            = t.title,
